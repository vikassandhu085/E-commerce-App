  ...
  .post(function (req, res) {
    ...
    userModel.findOne({ email: email }).then(function (user) {
      ...
      if (user === null) {
        ...
        var url = `<h1>Hi ${user.username} </h1><br><br> <h2>Need to reset your password? No Problem! Just click the link given below and you will be on your way.<br> If you did not make this request, please ignore this email  </h2><a href="http://localhost:3000/changePassword/${user._id}"><button  >RESET YOUR PASSWORD</button></a>`;
